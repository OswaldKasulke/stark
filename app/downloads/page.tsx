...
export default function DownloadsPage(){
  ...
  return <main className="downloads-page">
    ...
    <section className="downloads-content section">
      <div className="section-head"><div><p className="eyebrow">Checklisten</p><h2>Praktische Hilfen für Ihren Immobilienverkauf.</h2></div><p>Die Verkaufs- und Notarchecklisten sind auf Bergisch Gladbach und das Bergische Land abgestimmt.</p></div>
