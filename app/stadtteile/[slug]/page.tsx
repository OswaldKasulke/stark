...
export default async function DistrictPage({params}:{params:Promise<{slug:string}>}){
  ...
  return <main className="district-page">
    ...
    <section className="district-contact section" id="kontakt"><div><p className="eyebrow light">Kostenlose Erstberatung</p><h2>Immobilienbewertung in {district.name}</h2><p>Unverbindliche Anfrage an unser Team in Bergisch Gladbach.</p></div><div><a className="button gold" href="/immobilienbewertung/#bewertung">Bewertung anfragen</a><a href="tel:+4922049147881">+49 2204 914 7881</a></div></section>
