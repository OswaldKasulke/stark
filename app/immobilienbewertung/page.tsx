...
const faqs: Array<[string,string]> = [
  ["Was ist meine Immobilie in Bergisch Gladbach wert?", "Der Rechner ordnet die vollständige Adresse einer amtlichen Immobilienrichtwertzone zu und passt deren Richtwert mit den veröffentlichten Modellmerkmalen an. Das Ergebnis ist eine unverbindliche Ersteinschätzung und ersetzt keine Besichtigung."],
  ...
  ["Wie wird der Wohnungswert ermittelt?", "Ausgangspunkt ist der Immobilienrichtwert der konkreten amtlichen Zone zum 1. Januar 2026. Der Rechner wendet anschließend die für diesen Teilmarkt veröffentlichten Koeffizienten auf die eingegebenen Merkmale an."],
